...
^https?:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/?(.*?)*$) url script-response-body https://raw.githubusercontent.com/davysing/px/main/Scannerzuixin2.js

^https?:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/?(.*?)*$) url script-request-header https://raw.githubusercontent.com/davysing/px/main/Scannerzuixin2.js
...
const name = "plus";
const appid = "com.readdle.Scanner.subscription.year30";
